        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <h1 class="h3 mb-4 text-gray-800">
                    ...
                    <a href="exams-form.php" class="addmodal btn btn-success btn-sm float-right">
                                            ...
                                            <td>
                                                <?php 
                                                    if($today_date < $start_date && $today_date < $end_date){
                                                        ?>
                                                        <a href="exams-form.php?id=<?php echo $row->id?>" class="btn btn-primary btn-circle btn-sm">
                                                            <i class="fa fa-pen"></i>
                                                        </a>
                                                        <a href="process/exam.php?id=<?php echo $row->id;?>" onclick="return confirm('Are you sure you want to delete this exams?')" class="btn btn-danger btn-circle btn-sm">
